...
$stmt = $pdo->prepare('SELECT * FROM products WHERE subcat_id=5 ORDER BY name DESC LIMIT ?,?');
...
$total_products = $pdo->query('SELECT * FROM products WHERE subcat_id=5')->rowCount();
?>

<?=template_header('Condiments, Oils, Herbs & Spices')?>
...
<div class="products content-wrapper">
    <h1>Condiments, Oils, Herbs & Spices</h1>
    ...
    <div class="buttons">
        ...
        <a href="index.php?page=condoilherbspice&p=<?=$current_page-1?>">Prev</a>
        <?php endif; ?>
        <?php if ($total_products > ($current_page * $num_products_on_each_page) - $num_products_on_each_page + count($products)): ?>
        <a href="index.php?page=condoilherbspice&p=<?=$current_page+1?>">Next</a>
        <?php endif; ?>
    </div>
</div>
