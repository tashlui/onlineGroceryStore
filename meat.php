...
$stmt = $pdo->prepare('SELECT * FROM products WHERE subcat_id=3 ORDER BY name DESC LIMIT ?,?');
...
$total_products = $pdo->query('SELECT * FROM products WHERE subcat_id=3')->rowCount();
?>
